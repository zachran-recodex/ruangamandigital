...
<head>
  ...
  <style>
    ...
    ::-webkit-scrollbar-thumb { background: #C4ADE0; border-radius: 3px; }
    ...
    textarea:focus, input:focus, a:focus-visible, button:focus-visible {
...
<body class="bg-sand-50 font-sans text-slate-700 antialiased">
  ...
  <div id="toast" class="toast fixed bottom-6 left-1/2 -translate-x-1/2 z-[100] bg-safe-700 text-white px-6 py-4 rounded-2xl shadow-lg flex items-center gap-3 max-w-sm">
    <svg class="w-5 h-5 text-calm-300 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
    ...
    <div class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
      ...
      <a href="#hero" class="flex items-center gap-2.5 group" aria-label="Kembali ke beranda">
        <div class="w-8 h-8 rounded-full bg-gradient-to-br from-safe-300 to-calm-300 flex items-center justify-center">
          <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 3c-4.97 0-9 2.69-9 6v6c0 3.31 4.03 6 9 6s9-2.69 9-6V9c0-3.31-4.03-6-9-6z"/><path stroke-linecap="round" stroke-linejoin="round" d="M12 3c2.21 0 4 1.34 4 3v1c0 1.66-1.79 3-4 3S8 8.66 8 7V6c0-1.66 1.79-3 4-3z"/></svg>
        </div>
      ...
      <button id="mobile-menu-btn" class="md:hidden p-2 rounded-lg hover:bg-safe-50 transition-colors" aria-label="Buka menu navigasi">
        <svg class="w-5 h-5 text-safe-700" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h16"/></svg>
      </button>
    </div>
    <!-- Mobile Menu -->
      ...
      <div class="max-w-3xl mx-auto text-center">
        ...
        <div class="animate-gentle-fade-up-delay-3 flex flex-col sm:flex-row items-center justify-center gap-4">
          <a href="#bercerita" class="group inline-flex items-center gap-2 px-8 py-4 bg-safe-600 text-white font-semibold rounded-2xl hover:bg-safe-700 hover:shadow-lg hover:shadow-safe-200/50 transition-all duration-300">
            Mulai Bercerita
            <svg class="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/></svg>
          </a>
      ...
      <div class="max-w-2xl mx-auto">
        ...
        <div class="text-center mb-12">
          <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-calm-50 border border-calm-200/50 mb-4">
            <svg class="w-3.5 h-3.5 text-calm-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931z"/></svg>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <article class="bg-white/80 backdrop-blur-sm rounded-2xl border border-safe-100 p-6 hover:shadow-md hover:border-safe-200 transition-all duration-300 group">
          <div class="flex items-center gap-3 mb-4">
            <div class="w-9 h-9 rounded-full bg-gradient-to-br from-safe-200 to-calm-200 flex items-center justify-center">
              <svg class="w-4 h-4 text-safe-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0"/></svg>
            </div>
            <div>
        ...
        <article class="bg-white/80 backdrop-blur-sm rounded-2xl border border-safe-100 p-6 hover:shadow-md hover:border-safe-200 transition-all duration-300 group">
          <div class="flex items-center gap-3 mb-4">
            <div class="w-9 h-9 rounded-full bg-gradient-to-br from-calm-200 to-safe-200 flex items-center justify-center">
              <svg class="w-4 h-4 text-calm-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0"/></svg>
            </div>
            <div>
              <p class="text-sm font-semibold text-safe-800">Penyintas Anonim</p>
        ...
        <article class="bg-white/80 backdrop-blur-sm rounded-2xl border border-safe-100 p-6 hover:shadow-md hover:border-safe-200 transition-all duration-300 group">
          <div class="flex items-center gap-3 mb-4">
            <div class="w-9 h-9 rounded-full bg-gradient-to-br from-safe-300 to-calm-300 flex items-center justify-center">
              <svg class="w-4 h-4 text-safe-700" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0"/></svg>
            </div>
            <div>
              <p class="text-sm font-semibold text-safe-800">Penyintas Anonim</p>
        ...
        <div class="rounded-2xl border-2 border-dashed border-safe-200 bg-safe-50/50 p-6 flex flex-col items-center justify-center text-center min-h-[240px]">
          <div class="w-12 h-12 rounded-full bg-safe-100 flex items-center justify-center mb-4">
            <svg class="w-6 h-6 text-safe-400" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15"/></svg>
          </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl border border-safe-100 p-6 hover:shadow-md transition-all duration-300">
          <div class="w-11 h-11 rounded-xl bg-safe-100 flex items-center justify-center mb-5">
            <svg class="w-6 h-6 text-safe-600" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25"/></svg>
          </div>
          ...
          <ul class="space-y-2">
            <li class="flex items-start gap-2 text-xs text-slate-500">
              <svg class="w-4 h-4 text-calm-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>
        ...
        <div>
          ...
          <div class="bg-white/5 rounded-xl p-4">
            <div class="flex items-center gap-2 mb-2">
              <svg class="w-4 h-4 text-calm-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z"/></svg>
  ...
  <script>
    ...
    storyForm.addEventListener('submit', (e) => {
      ...
      // Scroll to gallery
      setTimeout(() => {
        document.getElementById('solidaritas').scrollIntoView({ behavior: 'smooth' });
      }, 1000);
    });
